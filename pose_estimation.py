"""
Complete Pose Estimation System with Reference Loading
...
class ReferencePoseEstimator:
    def __init__(self, yolo_model_path, reference_dir="reference_images", camera_index=1):
        self.cap = None
    ...
    def run(self):
        """Main loop"""
        print("\n" + "="*60)
        print("REFERENCE-BASED POSE ESTIMATION SYSTEM")
        print("="*60)
        print("\nFeatures:")
        ...
        try:
            while True:
                ...
                cv2.imshow('Reference-Based Pose Estimation', display_frame)
                ...
                if key == 27:
                    ...
                    filename = f"reference_tracking_{saved_count:03d}.jpg"
...
def main():
    ...
    estimator = ReferencePoseEstimator(yolo_model_path, reference_dir, camera_index)
