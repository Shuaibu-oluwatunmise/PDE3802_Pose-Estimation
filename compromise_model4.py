#!/usr/bin/env python3
"""
Compromise 5-Object 6DOF Pose Tracker (Model V3: YOLOv5n)
Based on compromise_model3.py but with:
1. Model Path: runs/detect/yolov5n_detect_V3/weights/best.
...
# CONFIGURATION
# ============================================================================
YOLO_MODEL_PATH = 'runs/detect/yolov5n_detect_V1/weights/best.pt'
if os.path.exists('runs/detect/yolov5n_detect_V1/weights/best.tflite'):
    YOLO_MODEL_PATH = 'runs/detect/yolov5n_detect_V1/weights/best.tflite'
elif os.path.exists('runs/detect/yolov5n_detect_V1/weights/best.onnx'):
    YOLO_MODEL_PATH = 'runs/detect/yolov5n_detect_V1/weights/best.onnx'
