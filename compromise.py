#!/usr/bin/env python3
"""
Compromise 5-Object 6DOF Pose Tracker
Based on hybrid_rpi4.py but with:
1. Increased Resolution (640x480)
2. Synchronous YOLO (No Async Lag)
3. Full Frame Scanning (No ROI reliance for detection)
4. Lower Confidence Threshold (0.55)
"""
...
class Full5ObjectTracker(Node):
    def __init__(self):
        ...
        self.get_logger().info("Init YOLO (Synchronous)...")
    ...
    def run(self):
        ...
        self.get_logger().info("Compromise Tracker Stated (640x480, Sync YOLO, Conf 0.55)")
